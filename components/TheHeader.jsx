...
const Header = () => {
  return (
    <div className="p-6 md:py-4 md:px-[147px] overflow-hidden      ">
      <div className="flex justify-end text-xl font-medium cursor-pointer">
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center mt-8 md:mt-[140px]">
        <div className="w-full md:w-[60%] flex flex-col items-center md:block">
          <div className="font-bold text-4xl leading-[55px] text-center md:text-left">
            Hi, I am Tai,
            <br/>
            Frontend Developer
          </div>
          <div className="text-base font-normal my-10 text-center md:text-left">
